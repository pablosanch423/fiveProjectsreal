...
sales.forEach(sale => { addToTotal(sale) });

// For loop to generate bar chart of phone sales
for (let i = 0; i < phones.length; i++) {

    let barChart = "";   // Variable to store HTML code for table cells used to create a bar chart
    ...
    // Insert the bChart HTML code into the first tbody element in the web document
